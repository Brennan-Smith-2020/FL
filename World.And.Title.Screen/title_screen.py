...
pygame.display.set_caption("Legend of the eternally lit flame")
...
layer_images = [
    ...
    pygame.image.load("World.And.Title.Screen/ParallaxBackground/ParallaxBackground/DownLayer.png").convert_alpha(),
    pygame.image.load("World.And.Title.Screen/ParallaxBackground/ParallaxBackground/MiddleLayer.png").convert_alpha(),
    pygame.image.load("World.And.Title.Screen/ParallaxBackground/ParallaxBackground/Light.png").convert_alpha(),
    pygame.image.load("World.And.Title.Screen/ParallaxBackground/ParallaxBackground/TopLayer.png").convert_alpha(),
]
...
title_text = "Legend of the eternally lit flame"
play_text = "Play"
